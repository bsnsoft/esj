// Generated from model/en16931/2017.json by bindings/csharp/tools/generate-typed-view.py.
// The registry is the source of the terms; this file is checked in and a test holds it to it.
using System;
using System.Collections.Generic;

namespace En16931.SemanticJson.Typed.V2017;

/// <summary>
/// The invoice of EN 16931-1:2017+A1:2019/AC:2020, read through the names the registry gives its terms.
/// </summary>
/// <remarks>
...
public sealed class Invoice : TypedView
{
    ...
    /// <summary>Buyer reference (BT-10), 0..1.</summary>
    public SemanticValue? BuyerReference => Read("BT-10");
    ...
    /// <summary>Payment terms (BT-20), 0..1.</summary>
    ...
    /// <summary>DOCUMENT LEVEL CHARGES (BG-21), 0..n.</summary>
...
public sealed class Buyer : TypedView
{
    ...
    /// <summary>Buyer identifier (BT-46), 0..1.</summary>
    public SemanticValue? Identifier => Read("BT-46");
...
/// <summary>DOCUMENT LEVEL CHARGES (BG-21), as one instance of the group.</summary>
public sealed class DocumentLevelCharge : TypedView
{
    ...
    /// <summary>Document level charge amount (BT-99), 1..1.</summary>
    public SemanticValue? Amount => Read("BT-99");

    /// <summary>Document level charge base amount (BT-100), 0..1.</summary>
    public SemanticValue? BaseAmount => Read("BT-100");

    /// <summary>Document level charge percentage (BT-101), 0..1.</summary>
    public SemanticValue? Percentage => Read("BT-101");

    /// <summary>Document level charge VAT category code (BT-102), 1..1.</summary>
    public SemanticValue? VatCategoryCode => Read("BT-102");

    /// <summary>Document level charge VAT rate (BT-103), 0..1.</summary>
    public SemanticValue? VatRate => Read("BT-103");

    /// <summary>Document level charge reason (BT-104), 0..1.</summary>
...
public sealed class DocumentTotals : TypedView
{
    ...
    /// <summary>Sum of charges on document level (BT-108), 0..1.</summary>
    ...
    /// <summary>Invoice total VAT amount in accounting currency (BT-111), 0..1.</summary>
...
public sealed class VatBreakdown : TypedView
{
    ...
    /// <summary>VAT category tax amount (BT-117), 1..1.</summary>
    ...
    /// <summary>VAT exemption reason code (BT-121), 0..1.</summary>
...
public sealed class InvoiceLine : TypedView
{
    ...
    /// <summary>Referenced purchase order line reference (BT-132), 0..1.</summary>
    ...
    /// <summary>INVOICE LINE CHARGES (BG-28), 0..n.</summary>
...
/// <summary>INVOICE LINE CHARGES (BG-28), as one instance of the group.</summary>
public sealed class Charge : TypedView
{
    ...
    /// <summary>Invoice line charge amount (BT-141), 1..1.</summary>
    public SemanticValue? Amount => Read("BT-141");

    /// <summary>Invoice line charge base amount (BT-142), 0..1.</summary>
    public SemanticValue? BaseAmount => Read("BT-142");

    /// <summary>Invoice line charge percentage (BT-143), 0..1.</summary>
    public SemanticValue? Percentage => Read("BT-143");

    /// <summary>Invoice line charge reason (BT-144), 0..1.</summary>
...
public sealed class Item : TypedView
{
    ...
    /// <summary>ITEM ATTRIBUTES (BG-32), 0..n.</summary>
...
/// <summary>ITEM ATTRIBUTES (BG-32), as one instance of the group.</summary>
public sealed class ItemAttribute : TypedView
{
    ...
    /// <summary>Item attribute name (BT-160), 1..1.</summary>
